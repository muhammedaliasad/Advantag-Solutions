...
public class Department
{
    ...
    public string? c_MPCCurrency { get; set; }
    ...
    public string? c_IncludedInBoard { get; set; }
    public string? c_IncludedInGAAP { get; set; }
    public string? c_IsLeaf { get; set; }
    ...
    public string? c_Passthrough { get; set; }
